...
export const auth = betterAuth({
  ...
  trustedOrigins: [
    ...(process.env.NODE_ENV === "development" ? ["http://localhost:3000", ...(process.env.V0_RUNTIME_URL ? [process.env.V0_RUNTIME_URL] : []), "https://*.vusercontent.net", "https://*.vercel.run", "https://*.v0.build"] : []),
